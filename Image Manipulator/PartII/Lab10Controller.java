...
public class Lab10Controller {
    ...
    public void open() {
        ...
        if (file != null) {
            ...
            view.setImage(image);
            upDated = image;
            view.setOnMouseClicked(this::action);
        } else {
    ...
    public void about() {
        ...
        a.setTitle("About code");
        a.setHeaderText("The author of the code: Cherise Malisa");
        a.setContentText("Program applies filters to any pictures loaded\n" +
                "If point on picture is clicked, value of color as string is "+
                "\nreturned in the text field below");
        a.showAndWait();
    }

    /**
     * writes to text field on GUI the color as a string of pixel
     * that was clicked on
     *
     * @param e event
     */
    public void action(MouseEvent e) {
        ...
        try {
            ...
            PixelReader reader = upDated.getPixelReader();
            pixelColor = reader.getColor(x, y);

            pixelColor1.setText(pixelColor.toString());
        } catch (IndexOutOfBoundsException exception) {
            System.out.println("area clicked on image is out of bounds");
        }
    }


    public void setModel(Lab10 model) {
        lab = model;
    }
}
